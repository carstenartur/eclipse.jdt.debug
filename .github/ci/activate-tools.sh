...
<toolchains>
  ...
  <toolchain><type>jdk</type><provides><id>JavaSE-11</id><version>11</version></provides><configuration><jdkHome>$tools/jdk11</jdkHome></configuration></toolchain>
  <toolchain><type>jdk</type><provides><id>JavaSE-17</id><version>17</version></provides><configuration><jdkHome>$tools/jdk17</jdkHome></configuration></toolchain>
  <toolchain><type>jdk</type><provides><id>JavaSE-21</id><version>21</version></provides><configuration><jdkHome>$tools/jdk21</jdkHome></configuration></toolchain>
...
# Keep this ID distinct from the parent POM's "eclipse" p2 repository.
# No credentials and no broad repository mirror are introduced.
cat > "$HOME/.m2/settings.xml" <<'EOF'
<settings xmlns="http://maven.apache.org/SETTINGS/1.2.0">
  <profiles><profile><id>eclipse-public</id>
    <repositories><repository><id>fork-eclipse-maven</id><url>https://repo.eclipse.org/content/repositories/eclipse/</url><releases><enabled>true</enabled></releases><snapshots><enabled>true</enabled></snapshots></repository></repositories>
    <pluginRepositories><pluginRepository><id>fork-eclipse-maven</id><url>https://repo.eclipse.org/content/repositories/eclipse/</url><releases><enabled>true</enabled></releases><snapshots><enabled>true</enabled></snapshots></pluginRepository></pluginRepositories>
